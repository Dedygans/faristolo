...
function registrasi($data)
{
    ...
    mysqli_query(
        $conn,
        "INSERT INTO `user` (`id`, `username`, `email`, `password`, `balance_avail`, `balance_panding`, `level`, `email_code_verified`, `email_verified_at`) VALUES (NULL, '$username','$email','$password', '0', '0', 'user','', '2022-06-29 20:41')"
    );
