...
if (isset($_POST['login']) ) {
  ...
  if(mysqli_num_rows($result) == 1 ) {
    ...
    $_SESSION['balance_avail'] = $row['balance_avail'];
    $_SESSION['balance_panding'] = $row['balance_panding'];
    $_SESSION['email_verified_at'] = $row['email_verified_at'];

if ( isset($_POST['login']) AND $_POST['username'] == null ) {
   echo "<script>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <?php 
                if(isset($error)) : ?>
                  <p style="color : red ; font-style: italic;" class="login-card-description" > email / password wrong </P>
                <?php endif; ?>
